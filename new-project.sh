...
echo "   4. Pregătește primul run zero-API:"
echo "      python3 execution/agency.py prepare eval-agent $PROJECT_ID"
echo "   5. Dă prompt packet-ul generat operatorului Codex sau Claude Code"
echo ""
