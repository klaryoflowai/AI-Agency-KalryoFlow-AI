# 🤖 AGENTS.md — AI Agency / Suită Agenți pentru Automatizare IMM-uri

> Acest fișier este citit automat de Codex și Codex Cowork la fiecare sesiune.
...
**Cine conduce:** CEO non-tehnic — toate deciziile de business sunt ale lui. Codex gestionează implementarea tehnică.
...
- Codex în main-chat ia deciziile arhitecturale și aplică modificările finale
...
- Claude Code poate fi folosit ca operator paralel/reviewer când ownership-ul fișierelor este clar
...
```
ai-agency/
├── AGENTS.md                    ← ești aici — context complet proiect
...
- Întotdeauna cere aprobare înainte de a modifica rules sau AGENTS.md
...
- [x] AGENTS.md complet și upgradrat
